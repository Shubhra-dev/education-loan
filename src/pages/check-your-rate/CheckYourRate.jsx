            ...
            <div className="rounded-md bg-white/80 shadow-[inset_0_0_50px_rgba(0,0,0,0.2)] w-full tab:w-[60%] p-2 sm:p-4 tab:p-8">
              ...
              <div>
                ...
                <Text align={`text-center`} font={`font-semibold`}>
                  Based on the information provided, you are eligible for an
                  education loan. Here are the loan options available to you:
                </Text>
              </div>
              ...
              <div className="mt-4">
                <button className="rounded-md w-full py-2 text-center font-semibold bg-primary text-white">
                  Start New Check
                </button>
              </div>
            </div>
